...
import zypher from '../../public/zypher.jpeg'
...
export function FeaturesSectionDemo() {
  const features = [
    {
      title: "Biggest cybersecurity community in VIT",
      description:
        "We have the biggest cybersecurity community in VIT and we are proud of it",
      skeleton: <SkeletonOne />,
      className:
        "col-span-1 lg:col-span-4 border-b lg:border-r dark:border-neutral-800",
    },
    {
      title: "We conduct some of the big events at VIT Chennai",
      description:
        "And we have receieved a lot of love from the community and participants",
      skeleton: <SkeletonTwo />,
      className: "border-b col-span-1 lg:col-span-2 dark:border-neutral-800",
    },
    {
      title: "Regular CTF events and workshops",
      description:
        "We participate in CTF events globally and also conduct workshops regularly",
      skeleton: <SkeletonThree />,
      className:
        "col-span-1 lg:col-span-3 lg:border-r  dark:border-neutral-800",
    },
    {
      title: "Opportunity to learn",
      description:
        "With our fantastic Technical and Development team, you can learn a lot",
    ...
    <div className="relative z-20 py-10 lg:py-40 max-w-7xl mx-auto">
      <div className="px-8">
        ...
        <p className="text-sm lg:text-base  max-w-2xl  my-4 mx-auto text-neutral-500 text-center font-normal dark:text-neutral-300">
          We organize mind blowing events and we try to do the unthinkable.
          See it for yourself
        </p>
      </div>
...
export const SkeletonOne = () => {
  return (
    <div className="relative flex py-8 px-2 gap-10 sm:h-[50vh]">
      ...
      <div className="absolute bottom-0 z-40 inset-x-0  bg-gradient-to-t from-gray-950 :via-black to-transparent w-full pointer-events-none" />
      <div className="absolute top-0 z-40 inset-x-0  bg-gradient-to-b from-gray-950 via-transparent to-transparent w-full pointer-events-none" />
    </div>
  );
};
...
export const SkeletonTwo = () => {
  const images = [
    zypher, hackerspace, hackOverFlow
  ];
